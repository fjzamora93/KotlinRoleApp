...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ChargemapLibraryAccessors laccForChargemapLibraryAccessors = new ChargemapLibraryAccessors(owner);
    ...
    private final VanpraLibraryAccessors laccForVanpraLibraryAccessors = new VanpraLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>chargemap</b>
     */
    public ChargemapLibraryAccessors getChargemap() {
        return laccForChargemapLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>vanpra</b>
     */
    public VanpraLibraryAccessors getVanpra() {
        return laccForVanpraLibraryAccessors;
    }
    ...
    public static class ChargemapLibraryAccessors extends SubDependencyFactory {

        public ChargemapLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getNumberpicker() {
            return create("chargemap.numberpicker");
        }
    ...
    public static class GoogleHiltAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public Provider<MinimalExternalModuleDependency> getTesting() {
            return create("google.hilt.android.testing");
        }
    ...
    public static class JetbrainsKotlinxLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutines() {
            return create("jetbrains.kotlinx.coroutines");
        }
    ...
    public static class SquareupLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>squareup.okhttp</b>
         */
        ...
        /**
         * Group of libraries at <b>squareup.retrofit</b>
         */
    ...
    public static class SquareupRetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public Provider<MinimalExternalModuleDependency> getGson() {
            return create("squareup.retrofit.gson");
        }

    }

    public static class VanpraLibraryAccessors extends SubDependencyFactory {
        private final VanpraDialogsLibraryAccessors laccForVanpraDialogsLibraryAccessors = new VanpraDialogsLibraryAccessors(owner);

        public VanpraLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>vanpra.dialogs</b>
         */
        public VanpraDialogsLibraryAccessors getDialogs() {
            return laccForVanpraDialogsLibraryAccessors;
        }

    }

    public static class VanpraDialogsLibraryAccessors extends SubDependencyFactory {

        public VanpraDialogsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>io.github.vanpra.compose-material-dialogs:core</b> coordinates and
         * with version <b>0.9.0</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("vanpra.dialogs.core");
        }

        /**
         * Dependency provider for <b>datetime</b> with <b>io.github.vanpra.compose-material-dialogs:datetime</b> coordinates and
         * with version <b>0.9.0</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDatetime() {
            return create("vanpra.dialogs.datetime");
        }
    ...
    public static class CrashlyticsVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("crashlytics"); }

        /**
         * Version alias <b>crashlytics.gradle</b> with value <b>2.9.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGradle() { return getVersion("crashlytics.gradle"); }
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         * with version reference <b>crashlytics.gradle</b>
         * <p>
    ...
    public static class GooglePluginAccessors extends PluginFactory {
        private final GoogleHiltPluginAccessors paccForGoogleHiltPluginAccessors = new GoogleHiltPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.google.hilt</b>
         */
        public GoogleHiltPluginAccessors getHilt() {
            return paccForGoogleHiltPluginAccessors;
        }

    }

    public static class GoogleHiltPluginAccessors extends PluginFactory {

        public GoogleHiltPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>google.hilt.android</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>hilt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getAndroid() { return createPlugin("google.hilt.android"); }
